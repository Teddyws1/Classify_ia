...
(function() {
    // 1. CSS CORRIGIDO PARA APARECER A IMAGEM
    const css = `
        .btn-flutuante-compartilhar {
            position: fixed; bottom: 30px; right: 30px; width: 65px; height: 65px;
            background-color: #FFD700; border: none; border-radius: 50%; cursor: pointer;
        ...
        .modal-box-qr {
            background: #0d1117; margin: 50px auto; padding: 25px; 
            width: 90%; max-width: 380px; border-radius: 25px;
            border: 1px solid #30363d; position: relative; color: white;
        }

        .qr-grid-main { display: flex; flex-direction: column; gap: 15px; }

        .qr-card-item { 
            background: #161b22; padding: 15px; border-radius: 18px; 
            display: flex; align-items: center; gap: 15px; border: 1px solid #30363d; 
        }

        /* FRAME DO QR - GARANTE QUE A IMAGEM APAREÇA */
        .qr-img-frame { 
            background: white; padding: 8px; border-radius: 10px; 
            min-width: 100px; min-height: 100px; /* Garante espaço para a imagem */
        ...
        .info-qr { text-align: left; }
        .tag-qr { color: #8b949e; font-size: 10px; font-weight: bold; margin: 0; }
        .nome-qr { color: #FFD700; font-weight: bold; font-size: 15px; display: block; margin: 4px 0; }
        
        .btn-wpp-qr { 
            background: #25d366; color: white; padding: 7px 12px; border-radius: 7px; 
            font-size: 11px; text-decoration: none; font-weight: bold; display: inline-block; margin-top: 5px;
        }

        .btn-lock-qr { 
            background: #FFD700; border: none; padding: 7px 12px; border-radius: 7px; 
            font-weight: bold; font-size: 11px; cursor: pointer; color: #000;
        }

        .fechar-qr { position: absolute; right: 20px; top: 15px; color: #FFD700; font-size: 30px; cursor: pointer; }

        /* BLUR PARA SEGURANÇA */
        .qr-blur-effect { filter: blur(18px); pointer-events: none; }
    `;
    ...
    container.innerHTML = `
        <button id="btnStartQR" class="btn-flutuante-compartilhar">
        ...
        <div id="modalMainQR" class="modal-overlay-qr">
            <div class="modal-box-qr">
                <span id="closeQR" class="fechar-qr">&times;</span>
                <h2 style="color:#FFD700; text-align:center; font-size:18px; margin-bottom:20px;">COMPARTILHAR</h2>
                
                <div class="qr-grid-main">
                    <div class="qr-card-item">
                        <div class="qr-img-frame">
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://teddyws1.github.io/Classify_ia/">
                        </div>
                        <div class="info-qr">
                            <p class="tag-qr">ACESSO LIVRE</p>
                            <span class="nome-qr">Site Público</span>
                            <a href="https://api.whatsapp.com/send?text=Site: https://teddyws1.github.io/Classify_ia/" target="_blank" class="btn-wpp-qr">WhatsApp</a>
                        </div>
                    </div>

                    <div class="qr-card-item" style="border-style: dashed; border-color: #FFD70055;">
                        <div id="blur-1" class="qr-img-frame qr-blur-effect">
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://ddp433w0-5500.brs.devtunnels.ms/">
                        </div>
                        <div class="info-qr">
                            <p class="tag-qr">RESTRITO</p>
                            <span class="nome-qr">ADM Servidor 1</span>
                            <button class="btn-lock-qr" onclick="window.unlockQR('blur-1', this)">SENHA</button>
                        </div>
                    </div>

                    <div class="qr-card-item" style="border-style: dashed; border-color: #ffd711;">
                        <div id="blur-2" class="qr-img-frame qr-blur-effect">
                            <img src="Https://i.postimg.cc/3JnRPPgn/URL-QR-Code-(1).png
                            1/create-qr-code/?size=100x100&data=https://6n7hkflq-5500.brs.devtunnels.ms/">
                        </div>
                        <div class="info-qr">
                            <p class="tag-qr">RESTRITO</p>
                            <span class="nome-qr">ADM Servidor 2</span>
                            <button class="btn-lock-qr" onclick="window.unlockQR('blur-2', this)">SENHA</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    // 3. LÓGICA DE ABRIR E SENHA
    const modal = document.getElementById('modalMainQR');
    document.getElementById('btnStartQR').onclick = () => modal.style.display = 'block';
    document.getElementById('closeQR').onclick = () => modal.style.display = 'none';

    window.unlockQR = function(id, btn) {
